...
[[nodiscard]] static __m128i aes_expand_key_evn_step(__m128i key0, __m128i key1)
{
...
void load_key_256(uint8_t w[240], const uint8_t key[AES_KEY_SIZE]) {
...
void encrypt_block_256(const uint8_t in[AES_BLOCK_SIZE], uint8_t out[AES_BLOCK_SIZE], const uint8_t roundKeys[240]) {
...
void decrypt_block_256(const uint8_t in[AES_BLOCK_SIZE], uint8_t out[AES_BLOCK_SIZE], const uint8_t roundKeys[240]) {
